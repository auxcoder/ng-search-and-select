(function (angular) {
  ...
  function SearchSelectController($scope, $sanitize, $document) {
		...
		$ctrl.$onInit = function() {
			...
			$ctrl.elmDisabled = angular.isDefined($ctrl.disabled) ? $ctrl.disabled : false;
		};
